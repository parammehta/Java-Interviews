...
public class TimeSeriesAggregation {
    ...
    public static void main(String args[]) throws Exception {
        ...
        sortRequestList();
        mergeRequestList();
        for (OutputEntity outputEntity : outputEntities) System.out.println(outputEntity.toString());
    }
    ...
    private static Request createRequestFromString(String
                                                           str) {
        String[] splitStr = str.split(", *");
...
class OutputEntity {
    ...
    public OutputEntity(Request request) {
        ...
        map = new TreeMap<>();
        map.put(request.getEngagement().getType(),
