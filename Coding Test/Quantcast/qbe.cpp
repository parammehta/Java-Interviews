...
void add_JSON(string, int, bool, vector<string> &, unordered_map<string, int> &,
         vector<unordered_map<string, vector<int>>> &);

void get_JSON(string, bool, vector<string> &, unordered_map<string, int> &, vector<unordered_map<string, vector<int>>> &);

void delete_JSON(string, bool, vector<string> &, unordered_map<string, int> &, vector<unordered_map<string, vector<int>>> &);
